...
BOT_OWNER_ROLE = 'cool' # change to what you need
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="__**HQ TRIVIA**__", description="**VIP SERVER**",color=0xFF0000)
        ...
        self.embed.set_footer(text=f"developed by 叉vipujo4321", \
...
#                 three_check = ":x:"            
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='HQ TRIVIA...'))
    ...
    async def on_message(self, message):
        ...
        if message.content.lower() == "hq":
            ...
            if BOT_OWNER_ROLE in [role.name for role in message.author.roles]:
                ...
                #await self.embed_msg.add_reaction("Ã¢Å“â€")
                await self.embed_msg.add_reaction("âŽ")
                #await self.embed_msg.add_reaction("Ã¢Å“â€")
        ...
        if message.content.startswith('&help'):
          if BOT_OWNER_ROLE in [role.name for role in message.author.roles]:
           ...
           embed.add_field(name="__Game__", value="*HQ TRIVIA*", inline=False)
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzQ0NTQzNDQ5NDI4MjYyOTEy.XzkwHw.IH6remGdVa9XORF_m_hkaSmDwMA'))
    loop.run_forever()
